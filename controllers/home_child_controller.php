        ...
        switch ($metas['socialdb_object_dc_type'][0]) {
            ...
            case 'image':
                ...
                if (get_the_post_thumbnail($object->ID, 'thumbnail')) {
                    ...
                    $content = '<center><img ' . $opacity_watermark . '" src="' . $url_image . '" class="img-responsive" /></center>';
                }
                break;
            case 'video':
		...
		switch ($metas['socialdb_object_dc_type'][0]) {
            ...
            case 'image':
                if (get_the_post_thumbnail($object->ID, 'thumbnail')) {
                    ...
                    $content = '<center><img src="' . $url_image . '" class="img-responsive" /></center>';
                } else {
            ...
            case 'video':
                if (strpos($metas['socialdb_object_content'][0], 'youtube') !== false) {
                    ...
                    $video_id = end($step1);
                    $content = "<iframe class='embed-responsive-item' src='https://player.vimeo.com/video/" . $video_id . "' frameborder='0'></iframe>";
                } else {
                    $content = "<iframe class='embed-responsive-item' src='" . $metas['socialdb_object_content'][0] . "' frameborder='0'></iframe>";
                }
                break;
            case 'pdf':
